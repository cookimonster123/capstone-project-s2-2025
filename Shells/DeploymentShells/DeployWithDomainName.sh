...
bash ../ViteConfigShells/DeployWithDomainNameViteConfig.sh

echo "Vite config deployment completed."

# Run the Caddyfile config
bash ../CaddyConfigShells/CaddyfileWithDomainName.sh
...
echo "Please go to server folder replace the CLIENT_URL, GOOGLE_CLIENT_ID, AWS S3 Configuration and SMTP Configuration in .env file with your EC2 public IPv4 address"
